		...
		>
			...
			>
				<div className="absolute left-6">
					<Link href="/">
						<Image 
							src="/assets/images/dhp-logo-primary.png" 
					...
					{links.map((link, i) => {
						...
						if (isHashLink) {
							return (
								<a 
									key={i} 
									className="px-3 py-2 text-sm font-medium text-foreground transition-all hover:text-[#34bb92] cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-[#34bb92] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
									href={link.href}
								>
									{link.label}
								</a>
							...
							return (
								<Link 
									key={i} 
									className={cn(
										"px-3 py-2 text-sm font-medium transition-all hover:text-[#34bb92] cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-[#34bb92] hover:after:scale-x-100 after:transition-transform after:duration-300",
										isActive ? "text-[#34bb92] after:scale-x-100" : "text-foreground after:scale-x-0"
									)}
									href={link.href}
								>
									{link.label}
