...
export function AnimatedDotsBackground() {
  ...
  const animateDots = useCallback(() => {
    ...
    dots.forEach((dot, index) => {
      ...
      const r = colorMatch ? colorMatch[1] : "52";
      const g = colorMatch ? colorMatch[2] : "187";
      const b = colorMatch ? colorMatch[3] : "146";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent 0%, #030303 90%), radial-gradient(ellipse at center, transparent 40%, #030303 95%)",
        }}
      ></div>
    </>
  );
